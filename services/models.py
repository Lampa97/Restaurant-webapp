...
class MealCategory(models.Model):
    ...
    image = models.ImageField(upload_to="menu/", verbose_name="Image", default="default_food.png")
...
class Meal(models.Model):
    ...
    image = models.ImageField(upload_to="meals/", verbose_name="Image", default="default_food.png")
